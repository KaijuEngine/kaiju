...
func NewVec3[T1, T2, T3 floatInput](x T1, y T2, z T3) Vec3 {
	return Vec3{Float(x), Float(y), Float(z)}
}

func NewVec3XYZ[T floatInput](xyz T) Vec3 {
	return Vec3{Float(xyz), Float(xyz), Float(xyz)}
}

func Vec3FromArray[T floatInput](a [3]T) Vec3 {
	return Vec3{Float(a[0]), Float(a[1]), Float(a[2])}
}

func Vec3FromSlice[T floatInput](a []T) Vec3 {
	return Vec3{Float(a[0]), Float(a[1]), Float(a[2])}
}

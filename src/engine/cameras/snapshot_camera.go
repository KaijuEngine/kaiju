...
type SnapshotCamera struct {
	...
	cascadeCount     uint8
	cascadeDistances [4]matrix.Float
}
...
func (c *SnapshotCamera) SetFOV(matrix.Float)              {}
func (c *SnapshotCamera) SetNearPlane(near matrix.Float)   { c.nearPlane = near }
func (c *SnapshotCamera) SetFarPlane(far matrix.Float)     { c.farPlane = far }
func (c *SnapshotCamera) SetWidth(width matrix.Float)      { c.width = width }
func (c *SnapshotCamera) SetHeight(height matrix.Float)    { c.height = height }
func (c *SnapshotCamera) ViewportChanged(width, height matrix.Float) {
	c.width, c.height = width, height
}
func (c *SnapshotCamera) SetProperties(_, near, far, width, height matrix.Float) {
...
func (c *SnapshotCamera) Width() matrix.Float                       { return c.width }
func (c *SnapshotCamera) Height() matrix.Float                      { return c.height }
...
func (c *SnapshotCamera) NearPlane() matrix.Float                   { return c.nearPlane }
func (c *SnapshotCamera) FarPlane() matrix.Float                    { return c.farPlane }
...
func (c *SnapshotCamera) CSMCascadeDistances() [4]matrix.Float      { return c.cascadeDistances }

...
func (p BorderTopWidth) Preprocess(values []rules.PropertyValue, ruleList []rules.Rule) ([]rules.PropertyValue, []rules.Rule) {
	return preprocBorderSideWidth(values, ruleList, "border-top")
}

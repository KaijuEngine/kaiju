...
func childLabels(elm markup.DocElement) []*ui.Label {
...
func (p TextAlign) Process(panel *ui.Panel, elm markup.DocElement, values []rules.PropertyValue, host *engine.Host) error {
	if len(values) != 1 {

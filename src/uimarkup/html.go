...
func DocumentFromHTML(host *engine.Host, htmlPath, cssPath string, withData any, funcMap map[string]func(*markup.DocElement)) *markup.Document {
...
func sizeTexts(doc *markup.Document, host *engine.Host) {
...
func DocumentFromHTMLString(host *engine.Host, html, cssStr string, withData any, funcMap map[string]func(*markup.DocElement)) *markup.Document {
	doc := markup.DocumentFromHTMLString(host, html, withData, funcMap)

...
type Property interface {
	Key() string
	Process(panel *ui.Panel, elm markup.DocumentElement, values []rules.PropertyValue, host *engine.Host) error
}
...
func (p %s) Process(panel *ui.Panel, elm markup.DocumentElement, values []rules.PropertyValue, host *engine.Host) error {

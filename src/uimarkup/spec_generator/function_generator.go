...
type Function interface {
	Key() string
	Process(panel *ui.Panel, elm markup.DocumentElement, value rules.PropertyValue) (string, error)
}
...
func (f %s) Process(panel *ui.Panel, elm markup.DocumentElement, value rules.PropertyValue) (string, error) {

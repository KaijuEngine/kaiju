...
func (c *LightEntityDataRenderer) Attached(host *engine.Host, manager *editor_stage_manager.StageManager, target *editor_stage_manager.StageEntity, data *entity_data_binding.EntityDataEntry) {
	...
	l.SetIntensity(matrix.Float(data.FieldValueByName("Intensity").(matrix.Float)))
	l.SetConstant(matrix.Float(data.FieldValueByName("Constant").(matrix.Float)))
	l.SetLinear(matrix.Float(data.FieldValueByName("Linear").(matrix.Float)))
	l.SetQuadratic(matrix.Float(data.FieldValueByName("Quadratic").(matrix.Float)))
	l.SetCutoff(matrix.Float(data.FieldValueByName("Cutoff").(matrix.Float)))
	l.SetOuterCutoff(matrix.Float(data.FieldValueByName("OuterCutoff").(matrix.Float)))
...
func (c *LightEntityDataRenderer) Update(host *engine.Host, target *editor_stage_manager.StageEntity, data *entity_data_binding.EntityDataEntry) {
	...
	l.light.Light.SetIntensity(matrix.Float(data.FieldValueByName("Intensity").(matrix.Float)))
	l.light.Light.SetConstant(matrix.Float(data.FieldValueByName("Constant").(matrix.Float)))
	l.light.Light.SetLinear(matrix.Float(data.FieldValueByName("Linear").(matrix.Float)))
	l.light.Light.SetQuadratic(matrix.Float(data.FieldValueByName("Quadratic").(matrix.Float)))
	l.light.Light.SetCutoff(matrix.Float(data.FieldValueByName("Cutoff").(matrix.Float)))
	l.light.Light.SetOuterCutoff(matrix.Float(data.FieldValueByName("OuterCutoff").(matrix.Float)))

...
func (p *PoolGroup[T]) selectPool() (*Pool[T], int) {
	for i := range p.pools {
...
func (p *PoolGroup[T]) Add() (elm *T, poolId int, elmId uint8) {
...
func (p *PoolGroup[T]) Remove(poolIndex int, elementId uint8) {
